...
class Demonstrator:
    ...
    def show(self):
        ...
        self.button = tk.Button(mainWindow, text="Add person", command=self.add_person, state=tk.DISABLED)
    ...
    def show_frame(self):
        ...
        # frame = func(frame)
        #frame, flag, other_ids = self.identification(frame)
    ...
    def show_entry(self):
        ...
        self.name_entry.place(anchor=tk.CENTER, relx=0.2, rely=0.9, width=150, height=50)
        self.name_entry.focus()

        self.confirm_button.place(anchor=tk.CENTER, relx=0.5, rely=0.9, width=150, height=50)
    ...
    def add_to_gallery(self):
        ...
        self.FaceRecog.gal_embs.append(new_emb)
        self.FaceRecog.gal_names.append(self.new_name)
        self.FaceRecog.gal_faces.append(new_face)

        # print(len(self.FaceRecog.gal_embs))
