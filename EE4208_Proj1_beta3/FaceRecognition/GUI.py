...
class Demonstrator:
    ...
    def show(self):
        ...
        mainWindow.title("Face Detection and Recognition")
        
        mainWindow.bind('<Escape>', lambda e: mainWindow.quit())
        lmain = tk.Label(mainWindow, compound=tk.CENTER, anchor=tk.CENTER, relief=tk.RAISED)

        #define the name entry box and confirm button
        #used in self.show_entry 
    ...
    def show_entry(self):
        ...
        #make 'add person' button disappear on click 
        self.button.place_forget()

        #define add another person button
        #it only shows up after click the 'add person' so I just put it here.
        #on click go back to show_entry
        ...
        #place name entry box and confirmation button
